#!/bin/bash
# Launch script for REAL ENVIRONMENT GRPO Training
# ================================================
# This script launches the fixed GRPO training that uses actual
# environment rollouts instead of mock trajectories
...
export DEVICE_TYPE="auto"  # Will auto-detect CUDA/MPS/CPU
...
OUTPUT_DIR="outputs/real-env-grpo-$(date +%Y%m%d-%H%M%S)"
mkdir -p $OUTPUT_DIR
...
echo "================================================"
echo "Starting REAL ENVIRONMENT GRPO Training"
echo "================================================"
